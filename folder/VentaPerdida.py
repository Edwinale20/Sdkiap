...
df_venta_perdida_filtrada = df_venta_perdida_filtrada[df_venta_perdida_filtrada['FAMILIA'] != 'VUSE']
df_venta_filtrada = df_venta_filtrada[df_venta_filtrada['FAMILIA'] != 'VUSE']
