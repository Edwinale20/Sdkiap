...
st.markdown("Datos a partir del 31 de julio del 2024,<br>A partir de la semana 34, los datos son venta pérdida y venta son de toda la semana (lunes-domingo)", unsafe_allow_html=True)
